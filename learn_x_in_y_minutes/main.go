...
func learnWebProgramming() {
	...
	// // In a real-world scenario, you might use synchronization primitives like WaitGroup
	// // Here, we use a simple sleep for demonstration purposes
	...
	// for {
	// 	fmt.Print("Type 'a' to make another request: ")
	// 	input, _ := reader.ReadString('\n')
	// 	if input == "a\n" {
	// 		requestServer()
	// 	} else {
	// 		fmt.Println("Invalid input. Please type 'a' to make another request.")
	// 	}
	// }
}
...
You can play around with the code on Go playground. Try to change it and run it from your browser! Note that you can use https://go.dev/play/ as a REPL to test things and code in your browser, without even installing Go.
